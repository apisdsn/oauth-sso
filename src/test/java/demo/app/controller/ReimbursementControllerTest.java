...
public class ReimbursementControllerTest {
    ...
    void testUpdateReimbursementWhenValidRequestThenReturnOk() throws Exception {
        ...
        verify(reimbursementService, times(1)).updateReimbursementUser(anyLong(), any(ReimbursementRequest.class), any(OAuth2AuthenticatedPrincipal.class));
    }
    ...
    void testDeleteReimbursementWhenValidRequestThenReturnOk() throws Exception {
        ...
        doNothing().when(reimbursementService).removeReimbursementByUser(anyLong(), eq(principal));
